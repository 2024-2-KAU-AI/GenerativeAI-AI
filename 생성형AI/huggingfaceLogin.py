...
def load_ipynb_as_module(filename):
...
# 파일 경로 설정
path = '/content/drive/My Drive/Colab Notebooks/생성형AI/huggingfaceLogin.ipynb'

huggingfaceLogin = load_ipynb_as_module(path)
...
def handle_image_query(image_path, question):
    try:
        ...
        return f"이 이미지는 English를 나타내는 이미지입니다."
